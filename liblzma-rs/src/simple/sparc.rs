    ...
    while i < size {
        if *buffer.offset(i as isize) as ::core::ffi::c_int == 0x40 as ::core::ffi::c_int
            && *buffer.offset(i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
                & 0xc0 as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    ...
                    == 0xc0 as ::core::ffi::c_int
        {
            ...
            dest = (0 as uint32_t)
                .wrapping_sub(dest >> 22 as ::core::ffi::c_int & 1 as uint32_t)
                << 22 as ::core::ffi::c_int & 0x3fffffff as uint32_t
                | dest & 0x3fffff as uint32_t | 0x40000000 as uint32_t;
